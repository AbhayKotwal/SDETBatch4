...
//		String Url="https://opensource-demo.orangehrmlive.com/";
	...
	public void marketplaceOption () {
		WebElement MarketplaceOption =  Driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[8]/input"));
		System.out.println(MarketplaceOption.getText());
		MarketplaceOption.click();
	}*/
	...
	/*@Test(priority=3)
	public void welcomeUserOption() {
		WebElement WelcomeOption= Driver.findElement(By.xpath("/html/body/div[1]/div[1]/a[2]"));
		System.out.println(WelcomeOption.getText());
		WelcomeOption.click();
	}*/
	
	/*@Test(priority=4)
	public void adminOption() {
		WebElement AdminOption = Driver.findElement(By.xpath("/html/body/div[1]/div[2]/ul/li[1]/a/b"));
		System.out.println(AdminOption.getText());
		AdminOption.click();
	}*/
	@Test(priority=3)
	public void close() {
